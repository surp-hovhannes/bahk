...
class DevotionalSetAdminTest(TestCase):
    ...
    def test_devotional_set_admin_list_view(self):
        """Test that DevotionalSet appears in admin list"""
        ...
        url = reverse('admin:hub_devotionalset_changelist')
        response = self.client.get(url)
        
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "Test Set")
        
    def test_devotional_set_admin_create(self):
        """Test creating DevotionalSet through admin"""
        url = reverse('admin:hub_devotionalset_add')
        ...
        # Debug: Print response content if not redirect
    ...
    def test_devotional_set_admin_edit(self):
        ...
        url = reverse('admin:hub_devotionalset_change', args=[devotional_set.id])
        ...
        devotional_set.refresh_from_db()
        self.assertEqual(devotional_set.title, 'Updated Title')
        self.assertEqual(devotional_set.description, 'Updated description')
